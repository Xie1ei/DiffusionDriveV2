...
def cache_features_two_stage(args: List[Dict[str, Union[List[str], DictConfig]]]) -> List[Optional[Any]]:
    """
    Helper function to cache features and targets of learnable agent.
    :param args: arguments for caching
    """
...
def main(cfg: DictConfig) -> None:
    ...
    length = len(scene_loader)
    _ = worker_map(worker, cache_features_two_stage, data_points)
    logger.info(f"Finished caching {length} scenarios for training/validation dataset")
